...
Source0  : https://storage.googleapis.com/aom-releases/libaom-3.6.1.tar.gz
Source1  : https://storage.googleapis.com/aom-releases/libaom-3.6.1.tar.gz.asc
...
%prep
%setup -q -n libaom-3.6.1
cd %{_builddir}/libaom-3.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707083177
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libaom.so.3.6.1
/usr/lib64/libaom.so.3
/usr/lib64/libaom.so.3.6.1
